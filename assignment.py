...
for student in students:
    ...
    if student['score'] >= 70:
        high_performers[student['id']] = (student['name'], student['score'])
    elif student['score'] >= 50:
        average_performers[student['id']] = (student['name'], student['score'])
    else:
        low_performers[student['id']] = (student['name'], student['score'])


print(f"High Performers: {len(high_performers)} students")
print(f"Average Performers: {len(average_performers)} students")
print(f"Low Performers: {len(low_performers)} students\n")


print("High Performers:")
for id, info in high_performers.items():
    print({id: info})

print("\nAverage Performers:")
for id, info in average_performers.items():
    print({id: info})

print("\nLow Performers:")
for id, info in low_performers.items():
    print({id: info})
